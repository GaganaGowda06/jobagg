"""Fetch Lever jobs, store them in jobagg.db, and classify the unclassified
...
# Verified UK/EU tech, fintech, and AI employers on Lever. Veeva
# deliberately excluded: ~90 jobs in a live fetch, all Consultant/Manager/
# Product-Manager titles, zero hands-on technical roles.
SITE_SLUGS = [
    "zopa",
    "moonpig",
    "ekimetrics",
...
def main() -> None:
    conn = connect()
    print(f"Fetching from {len(SITE_SLUGS)} companies...")
